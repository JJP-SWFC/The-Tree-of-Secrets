var systemComponents = {
	...
	'overlay-head': {
		...
		<button class="overlayThing pointsThing" id="points" onclick="getPoint()">{{format(player.points)}}</button>
    ...
    'info-tab': {
		...
		<a class="link" href="https://galaxy.click/user/181" target="_blank" v-bind:style="{'font-size': '16px'}">My galaxy profile</a><br>
		<br><br>
    ...
    'options-tab': {
        ...
        <table>
			...
			<br><br><br>
			<tr>
			<td><button style="background: none; border: none;" class="opt" onclick="foundIt(); needsCanvasUpdate = true"></button></td>
			</tr>
		</table>`
    },
